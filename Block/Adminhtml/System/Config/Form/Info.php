    ...
    public function render(AbstractElement $element)
    {
        ...
        <div class="col-info">
            <div class="product-icon">
                <a
                title="' .$this->escapeHtml($fullModuleTitle) . '"
                href="' . $this->escapeHtml($moduleUrl) .  $utmParam . '&utm_campaign=extension-logo"
                target="_blank"
                >
                    <img
                    src="' .  $moduleImage . '"
            ...
            <div class="product-info-wrapper">
                <div class="row-1">
                    <div class="block-title">
                        <a
                        href="' . $this->escapeHtml($moduleUrl) .  $utmParam . '&utm_campaign=extension-name"
                        target="_blank"
                        >' .
                ...
                <div class="row-2">
                    <span class="block-dev">developed by
                        <a
                        href="' . 'https://mage' . 'fan.com' . $utmParam . '&utm_campaign=developed-by-magefan"
                        target="_blank"
                        >Mage' . 'fan</a>
                    </span>' .
                    ($latestVersion ? '
                    ...
                    <span class="block-guide">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                            <path d="M6.41797 16.4987H15.5846C16.314 16.4987 17.0135 16.209 17.5292 15.6932C18.0449
                            15.1775 18.3346 14.478 18.3346 13.7487V4.58203C18.3346 3.85269 18.0449 3.15321 17.5292
                            2.63749C17.0135 2.12176 16.314 1.83203 15.5846 1.83203H6.41797C5.68862 1.83203 4.98915
                            2.12176 4.47343 2.63749C3.9577 3.15321 3.66797 3.85269 3.66797 4.58203V17.4154C3.66797
                            18.1447 3.9577 18.8442 4.47343 19.3599C4.98915 19.8756 5.68862 20.1654 6.41797
                            20.1654H17.418C17.6611 20.1654 17.8942 20.0688 18.0662 19.8969C18.2381 19.725 18.3346
                            19.4918 18.3346 19.2487C18.3346 19.0056 18.2381 18.7724 18.0662 18.6005C17.8942 18.4286
                            17.6611 18.332 17.418 18.332H6.41797C6.17485 18.332 5.9417 18.2355 5.76979 18.0635C5.59788
                            17.8916 5.5013 17.6585 5.5013 17.4154C5.5013 17.1723 5.59788 16.9391 5.76979 16.7672C5.9417
                            16.5953 6.17485 16.4987 6.41797 16.4987ZM5.5013 4.58203C5.5013 4.33892 5.59788 4.10576
                            5.76979 3.93385C5.9417 3.76194 6.17485 3.66536 6.41797 3.66536H15.5846C15.8278 3.66536
                            16.0609 3.76194 16.2328 3.93385C16.4047 4.10576 16.5013 4.33892 16.5013
                            4.58203V13.7487C16.5013 13.9918 16.4047 14.225 16.2328 14.3969C16.0609 14.5688 15.8278
                            14.6654 15.5846 14.6654H6.41797C6.10573 14.6652 5.79574 14.7182 5.5013 14.8221V4.58203Z"
                            fill="#DA5D28"
                            />
                            <path d="M10.9987 12.8333C11.2418 12.8333 11.475 12.7368 11.6469 12.5648C11.8188 12.3929
                            11.9154 12.1598 11.9154 11.9167V9.16667C11.9154 8.92355 11.8188 8.69039 11.6469
                            8.51849C11.475 8.34658 11.2418 8.25 10.9987 8.25C10.7556 8.25 10.5224 8.34658 10.3505
                            8.51849C10.1786 8.69039 10.082 8.92355 10.082 9.16667V11.9167C10.082 12.1598 10.1786
                            12.3929 10.3505 12.5648C10.5224 12.7368 10.7556 12.8333 10.9987 12.8333Z"
                            fill="#DA5D28"
                            />
                            <path d="M10.9987 7.33333C11.505 7.33333 11.9154 6.92293 11.9154 6.41667C11.9154 5.91041
                            11.505 5.5 10.9987 5.5C10.4924 5.5 10.082 5.91041 10.082 6.41667C10.082 6.92293 10.4924
                            7.33333 10.9987 7.33333Z"
                            fill="#DA5D28"
                            />
                        </svg>
                        <span>
                        <a
                        href="' .  $documentationUrl . $utmParam . '&utm_campaign=user-guide"
                        target="_blank"
                        >
                        User Guide
                        </a>
                    ...
                    <span class="block-review">
						...
						<span>
							<a href="' . $this->appendUtmToUrl($moduleReviewUrl, $utmParam . '&utm_campaign=review-link') . '" target="_blank" >Leave a Review (Get $10)</a>
						</span>
					</span>
					' : ' ') . '
                </div>
            ...
            <div class="actions">';
                ...
                if (!$canUpgradeToMaxPlan && !$newVersionAvailable && $moduleReviewUrl) {
                    $html .= '<div class="block-action-review">
                                    <button id="review" title="Leave a Review (Get $10 in reward points)" class="action-review" onclick="window.open(\'' . $this->appendUtmToUrl($moduleReviewUrl, $utmParam . '&utm_campaign=review-button') . '\', \'_blank\'); return false;">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <style>
            @font-face {
                ...
                font-weight: 200 800;
                font-display: swap;
                src: url("' . $this->getViewFileUrl($fontPath) .'") format("woff2");
            ...
            .section-info .col-actions button span {
                font-family: "Plus Jakarta Sans", sans-serif;
                font-size: 18px;
                font-weight: 500;
                line-height: 24px;
            ...
            .section-info .col-actions button.action-upgrade {
                color: #344054;
                background: #ffffff;
                border: 1px solid #D0D5DD;
                box-shadow: 0 1px 2px 0 rgba(16,24,40,0.05);
            }
            .section-info .col-actions button.action-update {
                display: flex;
                align-items: center;
                color: #ffffff;
                background: #494542;
            ...
            .section-info .col-actions button.action-update .mf-icon {
                width: 44px;
                height: 42px;
                display: flex;
                align-items: center;
            ...
            .section-info .col-actions .available-version {
                font-size: 16px;
                font-weight: 500;
                line-height: 24px;
                margin-top: 10px;
